...
(
  ...
  COLLATE = utf8mb4_unicode_ci COMMENT ='Informações complementares das roles do Casbin';

INSERT INTO `panel_role_info`
VALUES (1, 'guest', 'Visitante', 'Acesso público sem autenticação', 1, 0, '2025-11-10 05:50:14', NULL,
        '2025-11-10 05:50:14', NULL),
       (2, 'user', 'Usuário', 'Usuário autenticado com permissões padrão', 1, 0, '2025-11-10 05:50:14', NULL,
        '2025-11-10 05:50:14', NULL),
       (3, 'admin', 'Administrador', 'Acesso total ao sistema (não pode ser modificado)', 1, 1, '2025-11-10 05:50:14',
        NULL, '2025-11-10 05:50:14', NULL);
